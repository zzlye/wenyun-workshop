...
export const GPT_IMAGE_2_SUPER_MODEL = GPT_IMAGE_2_VIP_MODEL
export const GPT_IMAGE_2_VIP_REQUEST_MODEL = 'gpt-image-2-vip'
export const GPT_IMAGE_2_SUPER_REQUEST_MODEL = GPT_IMAGE_2_VIP_REQUEST_MODEL
...
export const FIXED_IMAGE_MODEL_PRICING: FixedImageModelPricing[] = [
  ...
  { model: GPT_IMAGE_2_VIP_MODEL, label: GPT_IMAGE_2_VIP_MODEL, requestModel: GPT_IMAGE_2_VIP_REQUEST_MODEL, unitCostText: 'HUHN 0.09', resolutionText: '1K、2K、4K' },
  { model: GPT_IMAGE_2_4K_MODEL, label: GPT_IMAGE_2_4K_MODEL, requestModel: GPT_IMAGE_2_4K_REQUEST_MODEL, unitCostText: 'HUHN 0.15', resolutionText: '1K、2K、4K' },
...
export function getFixedImagePricing(model: string): FixedImageModelPricing | null {
  ...
  if (/^gpt-image-2-(?:vip|超分)$/i.test(normalized)) {
    return FIXED_IMAGE_MODEL_PRICING.find((item) => item.model === GPT_IMAGE_2_VIP_MODEL) ?? null
  }
...
export function normalizeFixedImageModel(value: unknown): string {
  ...
  if (/^gpt-image-2-(?:vip|超分)$/i.test(model)) return GPT_IMAGE_2_VIP_MODEL
